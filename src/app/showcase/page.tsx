...
function UnderConstruction() {
  return (
    <>
      ...
      {/* In-flow banner above the page title: a fixed corner badge collided with
          the theme toggle (desktop) and the footer text (mobile). */}
      <div className="mb-6 flex items-center gap-2 rounded-full border border-amber-300/50 bg-amber-50/90 dark:bg-amber-900/25 dark:border-amber-500/30 px-3.5 py-1.5 backdrop-blur-sm shadow-sm">
